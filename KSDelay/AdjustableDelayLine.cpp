...
{
    AdjustableDelayLine::AdjustableDelayLine() : delayMsec(-1.0), pBuffer(0)
    {
    }
    ...
    void AdjustableDelayLine::setDryFraction(float fraction)
    {
        dryFraction = fraction;
    }
